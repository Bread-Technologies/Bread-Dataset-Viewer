...
- **~12,300 lines of Lean** (excluding Mathlib dependencies); Examples.lean
  alone past 10,750 lines
- **~720+ verified theorems / examples** (no `sorry` outside documented placeholders)
- **14 documentation files** (~75 KB of structured exposition)
- **1049+ commits** to the research branch
