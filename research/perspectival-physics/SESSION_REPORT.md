...
- **~12,100 lines of Lean** (excluding Mathlib dependencies); Examples.lean
  alone past 10,500 lines
- **~680+ verified theorems / examples** (no `sorry` outside documented placeholders)
- **14 documentation files** (~75 KB of structured exposition)
- **1038+ commits** to the research branch
