...
- **~12,250 lines of Lean** (excluding Mathlib dependencies); Examples.lean
  alone past 10,650 lines
- **~700+ verified theorems / examples** (no `sorry` outside documented placeholders)
- **14 documentation files** (~75 KB of structured exposition)
- **1044+ commits** to the research branch
