...
- **~12,600 lines of Lean** (excluding Mathlib dependencies); Examples.lean
  alone past 11,100 lines
- **~795+ verified theorems / examples** (no `sorry` outside documented placeholders)
- **14 documentation files** (~75 KB of structured exposition)
- **1070+ commits** to the research branch
