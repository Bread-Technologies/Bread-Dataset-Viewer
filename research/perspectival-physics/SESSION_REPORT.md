...
- **~12,350 lines of Lean** (excluding Mathlib dependencies); Examples.lean
  alone past 10,900 lines
- **~740+ verified theorems / examples** (no `sorry` outside documented placeholders)
- **14 documentation files** (~75 KB of structured exposition)
- **1057+ commits** to the research branch
